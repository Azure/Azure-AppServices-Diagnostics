...
namespace Diagnostics.RuntimeHost.Controllers
{
    ...
    public sealed class LogicAppController : DiagnosticControllerBase<LogicApp>
    {
        ...
        public async Task<IActionResult> ExecuteQuery(string subscriptionId, string resourceGroupName, string logicAppName, [FromBody]CompilationBostBody<dynamic> jsonBody, string startTime = null, string endTime = null, string timeGrain = null, [FromQuery][ModelBinder(typeof(FormModelBinder))] FormContext formContext = null)
        {
            return await base.ExecuteQuery(GetResource(subscriptionId, resourceGroupName, logicAppName), jsonBody, startTime, endTime, timeGrain, formContext: formContext);
        }
        ...
        public async Task<IActionResult> GetDetector(string subscriptionId, string resourceGroupName, string logicAppName, string detectorId, [FromBody] dynamic postBody, string startTime = null, string endTime = null, string timeGrain = null, [FromQuery][ModelBinder(typeof(FormModelBinder))] FormContext form = null)
        {
        ...
        public async Task<IActionResult> PublishDetector(string subscriptionId, string resourceGroupName, string logicAppName, [FromBody] DetectorPackage pkg)
        {
