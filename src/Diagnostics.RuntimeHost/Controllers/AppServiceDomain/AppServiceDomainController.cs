...
namespace Diagnostics.RuntimeHost.Controllers
{
    ...
    public sealed class AppServiceDomainController : DiagnosticControllerBase<AppServiceDomain>
    {
        ...
        public async Task<IActionResult> GetSystemInvoker(string subscriptionId, string resourceGroupName, string domainName, string invokerId, string detectorId, [FromBody] dynamic postBody, string startTime = null, string endTime = null, string timeGrain = null)
        {
            return await base.GetSystemInvoker(GetResource(subscriptionId, resourceGroupName, domainName), invokerId, detectorId, startTime, endTime, timeGrain);
        }
