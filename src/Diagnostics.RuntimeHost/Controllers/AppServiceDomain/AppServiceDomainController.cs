...
namespace Diagnostics.RuntimeHost.Controllers
{
    ...
    public sealed class AppServiceDomainController : DiagnosticControllerBase<AppServiceDomain>
    {
        ...
        public async Task<IActionResult> ExecuteQuery(string subscriptionId, string resourceGroupName, string domainName, [FromBody]CompilationBostBody<dynamic> jsonBody, string startTime = null, string endTime = null, string timeGrain = null, [FromQuery][ModelBinder(typeof(FormModelBinder))] FormContext formContext = null)
        {
            return await base.ExecuteQuery(GetResource(subscriptionId, resourceGroupName, domainName), jsonBody, startTime, endTime, timeGrain, formContext: formContext);
        }
        ...
        public async Task<IActionResult> GetDetector(string subscriptionId, string resourceGroupName, string domainName, string detectorId, [FromBody] dynamic postBody, string startTime = null, string endTime = null, string timeGrain = null, [FromQuery][ModelBinder(typeof(FormModelBinder))] FormContext form = null)
        {
