...
namespace Diagnostics.RuntimeHost.Controllers
{
    ...
    public class ContainerAppController : DiagnosticControllerBase<ContainerApp>
    {
        ...
        public async Task<IActionResult> GetInsights(string subscriptionId, string resourceGroupName, string siteName, [FromBody] dynamic postBody, string pesId, string supportTopicId = null, string sapPesId = null, string sapSupportTopicId = null, string supportTopic = null, string startTime = null, string endTime = null, string timeGrain = null)
        {
            ...
            return await base.GetInsights(new ContainerApp(subscriptionId, resourceGroupName, siteName), pesId, supportTopicId, sapPesId, sapSupportTopicId, startTime, endTime, timeGrain, supportTopic, postBodyString);
        }
