...
namespace Diagnostics.RuntimeHost.Services.SourceWatcher.Watchers
{
    ...
    {
        public NationalCloudStorageWatcher(IHostingEnvironment env, IConfiguration configuration, IStorageService service, IInvokerCacheService invokerCacheService, IGistCacheService gistCacheService, IKustoMappingsCacheService kustoMappingsCacheService, IGithubClient githubClient, IDiagEntityTableCacheService tableCacheService) : base(env, configuration, service, invokerCacheService, gistCacheService, kustoMappingsCacheService, githubClient, tableCacheService)
        {
